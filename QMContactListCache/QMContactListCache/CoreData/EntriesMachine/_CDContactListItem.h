...
extern const struct CDContactListItemRelationships {
} CDContactListItemRelationships;

extern const struct CDContactListItemFetchedProperties {
} CDContactListItemFetchedProperties;
...
@property int16_t subscriptionStateValue;
...
@interface _CDContactListItem (CoreDataGeneratedAccessors)
