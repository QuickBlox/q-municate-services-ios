...
@interface NSManagedObject (QMMagicalAggregationShortHand)
...
@interface NSManagedObject (QMMagicalFindersShortHand)
+ (NSArray *) findAll;
...
#endif
@end
@interface NSManagedObject (QMMagicalRecordShortHand)
...
+ (instancetype) createInContext:(NSManagedObjectContext *)context QM_DEPRECATED_WILL_BE_REMOVED_IN_PLEASE_USE("4.0", "createEntityInContext:");
- (BOOL) deleteEntity;
- (BOOL) deleteInContext:(NSManagedObjectContext *)context QM_DEPRECATED_WILL_BE_REMOVED_IN_PLEASE_USE("4.0", "deleteEntityInContext:");
...
@end
@interface NSManagedObject (QMMagicalRequestsShortHand)
...
@end
@interface NSManagedObjectContext (QMMagicalObservingShortHand)
...
@end
@interface NSManagedObjectContext (QMMagicalRecordShortHand)
...
- (void) QM_deleteObjects:(id <NSFastEnumeration>)managedObjects;
@end
#import "NSManagedObjectContext+QMMagicalSaves.h"
@interface NSManagedObjectContext (QMMagicalSavesShortHand)
- (void) saveOnlySelfWithCompletion:(QMSaveCompletionHandler)completion;
- (void) saveToPersistentStoreWithCompletion:(QMSaveCompletionHandler)completion;
- (void) saveOnlySelfAndWait;
- (void) saveToPersistentStoreAndWait;
- (void) saveWithOptions:(QMSaveOptions)mask completion:(QMSaveCompletionHandler)completion;
- (void) save QM_DEPRECATED_WILL_BE_REMOVED_IN("3.0");
- (void) saveWithErrorCallback:(void(^)(NSError *error))errorCallback QM_DEPRECATED_WILL_BE_REMOVED_IN("3.0");
- (void) saveInBackgroundCompletion:(void (^)(void))completion QM_DEPRECATED_WILL_BE_REMOVED_IN("3.0");
- (void) saveInBackgroundErrorHandler:(void (^)(NSError *error))errorCallback QM_DEPRECATED_WILL_BE_REMOVED_IN("3.0");
- (void) saveInBackgroundErrorHandler:(void (^)(NSError *error))errorCallback completion:(void (^)(void))completion QM_DEPRECATED_WILL_BE_REMOVED_IN("3.0");
- (void) saveNestedContexts QM_DEPRECATED_WILL_BE_REMOVED_IN("3.0");
- (void) saveNestedContextsErrorHandler:(void (^)(NSError *error))errorCallback QM_DEPRECATED_WILL_BE_REMOVED_IN("3.0");
- (void) saveNestedContextsErrorHandler:(void (^)(NSError *error))errorCallback completion:(void (^)(void))completion QM_DEPRECATED_WILL_BE_REMOVED_IN("3.0");
@end
@interface NSManagedObjectContext (QMMagicalThreadingShortHand)
+ (NSManagedObjectContext *) contextForCurrentThread;
+ (void) clearNonMainThreadContextsCache;
+ (void) resetContextForCurrentThread;
+ (void) clearContextForCurrentThread;
@end
@interface NSManagedObjectModel (QMMagicalRecordShortHand)
...
@end
@interface NSPersistentStore (QMMagicalRecordShortHand)
...
@end
@interface NSPersistentStoreCoordinator (QMMagicalRecordShortHand)
