//
//  NSManagedObject+QMMagicalAggregation.m
//  QMMagical Record
//
...
@implementation NSManagedObject (QMMagicalAggregation)
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
	return [self QM_numberOfEntitiesWithContext:[NSManagedObjectContext QM_contextForCurrentThread]];
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    return [self QM_countOfEntitiesWithContext:[NSManagedObjectContext QM_contextForCurrentThread]];
#pragma clang diagnostic pop
}
...
{
	NSError *error = nil;
	NSUInteger count = [context countForFetchRequest:[self QM_createFetchRequestInContext:context] error:&error];
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    return [self QM_countOfEntitiesWithPredicate:searchFilter inContext:[NSManagedObjectContext QM_contextForCurrentThread]];
#pragma clang diagnostic pop
}
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    return [self QM_hasAtLeastOneEntityInContext:[NSManagedObjectContext QM_contextForCurrentThread]];
#pragma clang diagnostic pop
}
...
{
	NSFetchRequest *request = [[self class] QM_createFetchRequestInContext:context];
...
+ (NSArray *) QM_aggregateOperation:(NSString *)collectionOperator onAttribute:(NSString *)attributeName withPredicate:(NSPredicate *)predicate groupBy:(NSString *)groupingKeyPath inContext:(NSManagedObjectContext *)context;
{
    ...
    NSFetchRequest *fetchRequest = [self QM_requestAllWithPredicate:predicate inContext:context];
