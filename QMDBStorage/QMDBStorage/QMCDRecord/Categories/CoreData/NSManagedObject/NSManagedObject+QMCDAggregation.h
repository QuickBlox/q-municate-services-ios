...
/**
 ...
 @since Available in v2.0 and later.
 */
+ (NSUInteger) QM_countOfEntitiesWithPredicate:(NSPredicate *)predicate inContext:(NSManagedObjectContext *)context;
...
/**
 ...
 This method is run against the default QMCDRecordStack's context.
