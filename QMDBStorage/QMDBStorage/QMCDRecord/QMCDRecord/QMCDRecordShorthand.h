...
@interface NSManagedObject (QMCDAggregationShortHand)
...
@interface NSManagedObject (QMCDFetchingShortHand)
...
@interface NSManagedObject (QMCDRecordShortHand)
...
@interface NSManagedObject (QMCDRecordOptionalShortHand)
...
@interface NSManagedObjectContext (QMCDObservingShortHand)
...
@interface NSManagedObjectContext (QMCDRecordShortHand)
...
@interface NSManagedObjectContext (QMCDSavesShortHand)
...
@interface NSManagedObjectModel (QMCDRecordShortHand)
...
@interface NSPersistentStoreCoordinator (QMCDAutoMigrationsShortHand)
...
@interface NSPersistentStoreCoordinator (QMCDInMemoryStoreAdditionsShortHand)
...
@interface NSPersistentStoreCoordinator (QMCDManualMigrationsShortHand)
...
@interface NSPersistentStoreCoordinator (QMCDRecordShortHand)
